    ...
    def get_config(self, platform: str, config_key: str) -> helion.Config:
        ...
        if platform_dict is None:
            ...
            raise KeyError(
                ...
                f"You can use --helion-platform to specify a platform "
                f"name explicitly (e.g. --helion-platform nvidia_h100). "
                f"If your device is a variant of a supported platform, "
