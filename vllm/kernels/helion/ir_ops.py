...
def register_as_simple_vllm_ir_impl(
    ...
    def _supports_args(*args, **kwargs) -> bool:
        ...
        return selected is not None or CaseKey.default() in config_keys

    _supports_args.__signature__ = sig  # type: ignore[attr-defined]

    @functools.wraps(kernel.raw_kernel_func)
    def helion_impl(*args, **kwargs):
        return kernel(*args, **kwargs)

    helion_impl.__signature__ = sig  # type: ignore[attr-defined]
